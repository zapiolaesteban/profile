...
function systemPrompt(kb) {
  return [
    ...
    "",
    "ASKING FOR CONTACT DETAILS — do this with visible care, because most people are giving a work address from inside a large organisation:",
    ...
    "- Make it their choice and say what actually happens to it, briefly and truthfully: it goes straight to Esteban as a private note, nobody else reads it, it isn't a mailing list, it isn't shared or sold, and there's no newsletter. Say it in one short line, not a privacy policy.",
    "- Always give them the alternative in the same breath: they can simply email him at estebangz@gmail.com instead and leave nothing here. Some people would rather reach out on their own terms and that is completely fine.",
    "- Never pressure, never imply they'll miss out, and never treat the address as the goal of the conversation. If they'd rather not, say that's no problem at all and carry on being useful.",
